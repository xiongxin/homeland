                ...
                <notempty name="_list">
                    <volist name="_list" id="vo">
                        <tr>
                            ...
                            <td>
                                <a title="签到列表" href="{:U('edit',array('id'=>$vo['id']))}">
                                    编辑
                                </a>
                                <a target="_blank" title="链接" href="<?= U('show/index',['id'=>$vo['id']])  ?>" class="">
                                    链接
                                </a>
                                <a title="删除" href="{:U('del?id='.$vo['id'])}" class="confirm ajax-get">
                                    删除
                                </a>
                            </td>
                        </tr>
...
<block name="script">
    ...
    <script type="text/javascript">
        ...
        //导航高亮
        highlight_subnav('{:U('Magic/index')}');
    </script>
</block>