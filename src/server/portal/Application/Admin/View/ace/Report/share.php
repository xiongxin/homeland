            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="search-form">
                        ...
                        <label>
                            <button class="btn btn-sm btn-primary" type="button" id="search" url="{:U('report/share')}">
...
-->
						<td>{$vo.stat_date}</td>
						<td>{$vo.baby_wonderful_share_count}</td>
						<td>{$vo.baby_mature_share_count}</td>
					</tr>
					</volist>
					<else/>
