            ...
            <div class="tab-content">
                <div id="person" class="tab-pane in active">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <label><input type="radio" class="ace" name="sex" value="MAN"><span class="lbl">男&nbsp;</span></label>
                            <label><input type="radio" class="ace" name="sex" value="MRS" checked><span class="lbl">女&nbsp;</span></label>
                        </div>
                        <span class="check-tips"></span>
                    </div>
                    <div class="form-group">
