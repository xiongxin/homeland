...
class Image{
    ...
    /**
     * 打开一幅图像
     * @param  string $imgblob 图片内容
     * @return Object          当前图片处理库对象
     */
    public function read($imgblob){
        $this->img->read($imgblob);
        return $this;
    }
     ...
     * @return Object             当前图片处理库对象
     */
    public function show($type = null, $quality=80,$interlace = true){
        return $this->img->show($type, $quality,$interlace);
    }
    /**
     * 返回图片宽度
     * @return integer 图片宽度
     ...
     * @return Object  当前图片处理库对象
     */
    public function combine($source, $x=0,$y=0){
        $this->img->combine($source, $x,$y);
        return $this;
    }
     ...
     * @return Object          当前图片处理库对象
     */
    public function text($text, $font, $size, $color = '#00000000', $x = 0, $y = 0, $angle=0){
        $this->img->text($text, $font, $size, $color, $x, $y, $angle);
        return $this;
    }
}
